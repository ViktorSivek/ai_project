        ...
        <nav className="bg-white w-full flex justify-between items-center mx-auto px-8 h-20 sticky top-0 overflow-auto z-50">
            ...
            <div className="flex justify-end items-center relative">
                ...
                {/* <a className="inline-block py-2 px-3 hover:bg-gray-200 rounded-full" href="#">
                    <div className="flex items-center relative cursor-pointer whitespace-nowrap">Refresh data</div>
                </a> */}
                        ...
                        <button type="button" className="inline-flex items-center relative px-2 border rounded-full hover:shadow-lg">
                            <div className="pl-1">
                                <svg
                                    ...
                                    role="presentation"
                                    focusable="false"
                                    className="display: block; fill: none; height: 16px; width: 16px; stroke: currentcolor; stroke-width: 3; overflow: visible;"
                                >
                            ...
                            <div className="block flex-grow-0 flex-shrink-0 h-10 w-12 pl-5 pt-1">
                                <svg
                                    viewBox="0 0 32 32"
                                    xmlns="http://www.w3.org/2000/svg"
                                    aria-hidden="true"
                                    role="presentation"
                                    focusable="false"
                                    className="display: block; height: 100%; width: 100%; fill: currentcolor;"
                                >
